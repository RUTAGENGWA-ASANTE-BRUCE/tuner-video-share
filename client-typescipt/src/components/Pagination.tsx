...
interface PaginationProps {
  videos: any[]; // Update the type for "videos" based on your data structure
  source: string;
  videosPerLoad: number;
}

const Pagination: React.FC<PaginationProps> = ({ videos, source, videosPerLoad }) => {
