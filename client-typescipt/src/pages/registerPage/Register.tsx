...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(`${process.env.REACT_APP_NODE_API}api/v1/auth/register`, {
        name,
        email,
        profession,
        phone,
    ...
    <div className="h-screen md:flex w-full">
      <div className="hidden lg:flex w-full lg:w-1/2 login_img_section justify-around items-center">
        ...
        <div className="w-full mx-auto px-20 space-y-6">
          <h1 className="text-8xl font-normal text-purple-400" id="marginT">
            Tuner
          </h1>
          <p className="text-white text-4xl" id="margin">
            Enjoy Multiple videos
          </p>
          <p className="text-white text-4xl" id="marginp">
            at one place
          </p>
          <div className="mt-40 pt-36">
            <NavLink
              to="/login"
              className="hover:text-indigo-800 hover:-translate-y-1 transition-all duration-500 text-white text-2xl mt-40 font-normal mb-2 underline"
              id="paddingT"
            >
              Sign In
            </NavLink>
      ...
      <div className="flex md:w-1/2 justify-center py-10 items-center bg-gray-800" id="padding">
        <form className="bg-gray-800 px-3" onSubmit={handleSubmit}>
          ...
          <div className="w-14 h-14 border-2 ml-24 rounded-full m text-white flex justify-center align-center">
            <p className="mt-3">+</p>
          </div>
          <div className="flex items-center border-b-2 py-2 px-3 mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M10 2a3 3 0 00-3 3v2a3 3 0 100 6v2a1 1 0 001 1h1" clipRule="evenodd" />
              <path d="M13 13h2a1 1 0 001-1v-1a3 3 0 10-3 3z" />
            </svg>
            <input
          ...
          <div className="flex items-center border-b-2 py-2 px-3 mb-4">
            ...
            <input
              className="pl-2 outline-none border-none bg-gray-800 text-white"
              type="text"
              name="email"
              id="email"
          ...
          <div className="flex items-center border-b-2 py-2 px-3 mb-4">
            ...
            <input
              className="pl-2 outline-none bg-gray-800 border-none px-5 text-white"
              type="text"
              name="phone"
              id="Phone"
              placeholder="Phone"
          ...
          <div className="flex items-center border-b-2 py-2 px-3 mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" strokeWidth="1.5" stroke="currentColor" className="h-5 w-5 text-gray-400">
          ...
          <button type="submit" className="block w-full bg-purple-400 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 hover:bg-indigo-800">
            Register
          </button>
        </form>
      </div>
